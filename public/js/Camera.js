...
Camera.prototype.update = function()
{
	...
	{		
		...
		if(this.axis == AXIS.VERTICAL || this.axis == AXIS.BOTH)
		{
			...
			if(this.followed.getY() - this.yView + this.yDeadZone > this.hView)
				this.yView = this.followed.getY() - (this.hView - this.yDeadZone);
			else if(this.followed.getY() - this.yDeadZone < this.yView)
				this.yView = this.followed.getY() - this.yDeadZone;
		}						
